...
(** Abstract datatype for variables.
 ...
 The set of all variables is partitioned into {b external} and {b fresh}
 and {b bound} variables.  There is a name of type {!Name.t} associated with 
 each such variable. Names for fresh variables are always of the form ["x!i"], 
...
val k : int ref
(** [k] is a global variable which is incremented by the {!Var.mk_fresh} 
